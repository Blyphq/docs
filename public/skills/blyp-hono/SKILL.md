---
name: blyp-hono
description: Portable Blyp add-on skill for Hono apps using blyp-js/hono, middleware on *, context.get("blypLog"), and automatic /inngest interception when enabled.
---
...
1. Import `createLogger` from `blyp-js/hono`.
...
- The app imports from `blyp-js/hono`
