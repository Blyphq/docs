---
name: blyp-nextjs
description: Portable Blyp add-on skill for Next.js App Router projects using blyp-js/nextjs, withLogger(), and clientLogHandler on the configured ingestion path.
---
...
1. Import `createLogger` from `blyp-js/nextjs`.
...
- The project imports from `blyp-js/nextjs`
