...
Likely cause:
This is a current upstream limitation, not a local configuration mistake.

Fix:
Treat the current CLI-generated schema as the supported contract. Do not add undocumented columns and assume Blyp will populate them automatically.
